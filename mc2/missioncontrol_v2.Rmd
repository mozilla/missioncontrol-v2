...
channel.info <- function(channel,g){
    list(
    version = posterior.current.versions(channel,g),
    usage   = posterior.usage(channel,g),
    summary = posterior.rate.incidence.summary(channel,g),
    evolution = posterior.evolution(channel,g)
    )
}
