...
makeActiveMenuBar("release",generatedText = glue("Using data till {till}",till=dall.rel2[,max(date)]))
```
...
```{r, out.extra='id="vgo1"'}
RE.WI2 <- 400
plotRolloutFigure(release.current.vs.previous,oss='Windows_NT', "Browser Crash Rate Comparison for Windows_NT,Release",whi='cmr',xtip='Rate',width=RE.WI2,height=200)
```
</div>

<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Windows_NT', "Browser Crash Incidence Comparison for Windows_NT,Release",whi='cmi',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Windows_NT', "Content Crash Rate Comparison for Windows_NT,Release",whi='ccr',xtip='Rate',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Windows_NT', "Content Crash Incidence Comparison for Windows_NT,Release",whi='cci',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
</div>
...
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Darwin', "Browser Crash Rate %Comparison for Darwin,Release",whi='cmr',xtip='Rate',width=RE.WI2,height=200)
```
</div>

<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Darwin', "Browser Crash Incidence Comparison for Darwin,Release",whi='cmi',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Darwin', "Content Crash Rate Comparison for Darwin,Release",whi='ccr',xtip='Rate',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Darwin', "Content Crash Incidence Comparison for Darwin,Release",whi='cci',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
</div>
...
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Linux', "Browser Crash Rate Comparison for Linux,Release",whi='cmr',xtip='Rate',width=RE.WI2,height=200)
```
</div>

<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Linux', "Browser Crash Incidence Comparison for Linux,Release",whi='cmi',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Linux', "Content Crash Rate Comparison for Linux,Release",whi='ccr',xtip='Rate',width=RE.WI2,height=200)
```
</div>
<div class = "col-md-6">
```{r}
plotRolloutFigure(release.current.vs.previous,oss='Linux', "Content Crash Incidence Comparison for Linux,Release",whi='cci',xtip='Incidence',width=RE.WI2,height=200)
```
</div>
</div>
