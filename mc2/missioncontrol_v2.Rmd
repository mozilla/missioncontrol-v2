...
(last 6 months)
5  But really what you need is the _raw_ data I used to compute (2)-(4). This
[zipped](./post_raw.csv.gz)  file contains 1000 draws from the posteriors for every model(one for each
