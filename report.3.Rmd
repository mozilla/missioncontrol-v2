...
rel.summary <- rel.posts[c_version==rel.current.version,][date==max(date),][, os:=reorder(os, levels=c("Windows_NT","Darwin","Linux"))]
...
beta.summary <- beta.posts[c_version==beta.current.version,][date==max(date),][, os:=reorder(os, levels=c("Windows_NT","Darwin","Linux"))]
