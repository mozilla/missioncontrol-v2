...
```{r echo=FALSE}
cmr.alert <- paste(as.character(beta.summary[, os[which(cmr.reg.prob>0.65)]]),collapse=",")
ccr.alert <- paste(as.character(beta.summary[, os[which(ccr.reg.prob>0.65)]]),collapse=",")
cmi.alert <- paste(as.character(beta.summary[, os[which(cmi.reg.prob>0.65)]]),collapse=",")
cci.alert <- paste(as.character(beta.summary[, os[which(ccr.reg.prob>0.65)]]),collapse=",")
