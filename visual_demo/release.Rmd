...
figs <- list(
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=cavgr.lo90,mn=cavgr.mean,hi90=cavgr.hi90,regProb=cavgr.reg.prob)],
                  "Current Average Crash",""),
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=cmr.lo90,mn=cmr.mean,hi90=cmr.hi90,regProb=cmr.reg.prob)],
                  "Current Browser Crash", ""),
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=ccr.lo90,mn=ccr.mean,hi90=ccr.hi90,regProb=ccr.reg.prob)],
...
```{r x3}
figs <- list(
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=100*cmi.lo90,mn=100*cmi.mean,hi90=100*cmi.hi90,regProb=cmi.reg.prob)],
                  "Current Browser Crash", ""),
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=100*cci.lo90,mn=100*cci.mean,hi90=100*cci.hi90,regProb=cci.reg.prob)],
                "Current Content Crash",""),
  makeSummaryPlot(rel.summary[, list(fac=as.character(os),lo90=100*cavgi.lo90,mn=100*cavgi.mean,hi90=100*cavgi.hi90,regProb=cavgi.reg.prob)],
                  "Current Average Crash","")
)
grid_plot(figs)
```
