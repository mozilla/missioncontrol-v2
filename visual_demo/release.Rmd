...
```{r x1,echo=FALSE}
cmr.alert <- paste(as.character(rel.summary[, os[which(cmr.reg.prob>0.7)]]),collapse=",")
ccr.alert <- paste(as.character(rel.summary[, os[which(ccr.reg.prob>0.7)]]),collapse=",")
cmi.alert <- paste(as.character(rel.summary[, os[which(cmi.reg.prob>0.7)]]),collapse=",")
cci.alert <- paste(as.character(rel.summary[, os[which(ccr.reg.prob>0.7)]]),collapse=",")
