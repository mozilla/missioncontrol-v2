...
builds <- data.table(versions=c("65.0b3","65.0b4","65.0b5","65.0b6","65.0b7","65.0b8","65.0b9","65.0b10","65.0b11","65.0b12",
                      ...
                      '69.0b3','69.0b4',"69.0b5","69.0b6","69.0b7","69.0b8","69.0b9","69.0b10","69.0b11",'69.0b12','69.0b13'
                                 ),
                     buildid = c('20181210164452','20181211223337','20181217180946','20181220174318','20181227144402','20190103150357','20190107180200','20190110221328','20190114172331',
                                 ...
                                 '20190801185445','20190805120428','20190807220259','20190812173625'
                                  ))
...
getPredictions <- function(M,D, wh,givenx=NULL){
  if(is.null(givenx)){
...
## For Beta
###################################################
beta.current.version <- '69.0b12'
beta.prev.version <- '69.0b11'
...
beta.trend <- beta.trend[c_version != '69.0b13',] #hack
beta.trend2 <-  beta.trend[major %in% c(beta.current.major,beta.prev.major),][order(as.numeric(major),as.numeric(minor)),]


## SAVE
u <- getwd()
setwd("visual_demo/_site/data/")
