...
```{r}
t.temp <- rel.posts[nvc > 0.1,][, list(os,date=as.Date(date),version=c_version, mn.orig=(cmr+ccr)/2, mn = cavgr.mean,lo90=cavgr.lo90, hi90=cavgr.hi90,smooth=cavgr.loess)]
